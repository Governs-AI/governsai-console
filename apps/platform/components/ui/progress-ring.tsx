...
export function ProgressRing({
  ...
  // Responsive size - smaller on mobile for 2-column layout
  const responsiveSize = size < 100 ? 100 : size > 160 ? 160 : size
      ...
      <div className="relative">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center">
          <div className="text-center">
            <div className="text-xl lg:text-2xl font-bold mb-1" style={{ color: '#000000' }}>
              {value}
            </div>
